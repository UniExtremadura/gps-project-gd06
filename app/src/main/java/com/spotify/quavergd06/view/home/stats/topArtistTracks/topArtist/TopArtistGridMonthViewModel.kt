...
class TopArtistGridMonthViewModel (
    repository: ArtistsRepository
) : ViewModel() {

    var user: User? = null

    private val _artist = repository.artistsMonths
    ...
    init {
        viewModelScope.launch {
            ...
            repository.tryUpdateRecentCache("medium_term")
        }
    }
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(
                ...
                return TopArtistGridMonthViewModel((application as QuaverApplication).appContainer.artistRepository) as T
            }
        }
    }
}