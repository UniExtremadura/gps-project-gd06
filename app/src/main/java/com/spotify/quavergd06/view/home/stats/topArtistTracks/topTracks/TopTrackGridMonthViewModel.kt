...
class TopTrackGridMonthViewModel (
    repository: TracksRepository
) : ViewModel() {

    var user: User? = null

    private val _tracks = repository.tracksMonths
    ...
    init {
        viewModelScope.launch {
            ...
            repository.tryUpdateCache("medium_term")
        }
    }
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(
                ...
                return TopTrackGridMonthViewModel((application as QuaverApplication).appContainer.tracksRepository) as T
            }
        }
    }
}