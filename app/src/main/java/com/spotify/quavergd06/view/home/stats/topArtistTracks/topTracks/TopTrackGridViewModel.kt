...
class TopTrackGridViewModel (
    repository: TracksRepository
) : ViewModel() {

    var user: User? = null

    private val _tracks = repository.tracks
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(
                ...
                return TopTrackGridViewModel((application as QuaverApplication).appContainer.tracksRepository) as T
            }
        }
    }
}