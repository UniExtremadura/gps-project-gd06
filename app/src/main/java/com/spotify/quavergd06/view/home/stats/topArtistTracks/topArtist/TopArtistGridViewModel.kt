...
class TopArtistGridViewModel(
    private val repository: ArtistsRepository
) : ViewModel() {

    var user: User? = null

    private val _artist = repository.artists
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(
                ...
                return TopArtistGridViewModel((application as QuaverApplication).appContainer.artistRepository) as T
            }
        }
    }
}
