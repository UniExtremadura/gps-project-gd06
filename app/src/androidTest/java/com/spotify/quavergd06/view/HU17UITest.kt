...
class HU17UITest {
    ...
    fun hU17UITest() {
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.titleTopTracks), withText("Top Tracks:"),
                withParent(withParent(withId(R.id.top_item_view_pager))),
                isDisplayed()
            )
        )
        textView2.check(matches(withText("Top Tracks:")))
        ...
        val recyclerView = onView(
            allOf(
                ...
                withParent(withParent(withId(R.id.fragmentTopTracks))),
                isDisplayed()
            )
        )
        ...
        textView3.check(matches(withText("4 WEEKS")))
        ...
        textView4.check(matches(withText("6 MONTHS")))
        ...
        textView5.check(matches(withText("ALL TIME")))
